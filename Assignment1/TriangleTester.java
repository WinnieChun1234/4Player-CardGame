...
public class TriangleTester {
	...
	/**
	 * To test the implementation of {@link Triangle}
	 * 
	 ...
	 * Testing a Triangle.
	 * 
	 * @param s The Triangle to be tested
	 */
	public static void testTriangle(Triangle s) {
	...
	/**
	 * Print out the parameter and screen coordinates of a Triangle.
	 * 
	 * @param s The Triangle that its information to be printed
	 */
	public static void printTriangleParams(Triangle s) {
